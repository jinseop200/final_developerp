          ...
          <ul class="navbar-nav mr-auto">	  
				  ...
				  <li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="${pageContext.request.contextPath}/board/boardclub.do">공지사항게시판</a>
						<a class="dropdown-item" href="${pageContext.request.contextPath}/board/boardNotice.do">동아리게시판</a>
					</div>
				  </li>
