...
<body>
      ...
      <div id="insert-container">
          <form class="needs-validation" action="${pageContext.request.contextPath}/document/enrollDocument.do" 
                ...
                <div class="form-row">
	                <div class="col-md-6 mb-3">
	                	<label for="storeNo">제  목</label>&nbsp;&nbsp;&nbsp;&nbsp;
	                    <input type="text" id="documentTitle" name="documentTitle" class="form-control bg-light small" placeholder="제목" aria-label="Search" aria-describedby="basic-addon2">
	                </div> 
                </div>
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label for="lotNo">결재자</label>&nbsp;&nbsp;
                        <input type="text" id="docLastapproval" name="docLastapproval" class="form-control bg-light small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
                        <button class="btn btn-primary searchSpec" type="button">
                            <i class="fas fa-search fa-sm"></i>
                        </button>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="lotNo">참조자 &nbsp; </label>&nbsp;&nbsp;
                        <input type="text" id="documentMiddle" name="documentMiddle" class="form-control bg-light small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
                        <button class="btn btn-primary searchSpec" type="button">
                            <i class="fas fa-search fa-sm"></i>
                        </button>
                    </div>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control quality-comment" name="documentContent" cols="80" rows="5" aria-label="With textarea"></textarea>	
                    </div>
                </div>
